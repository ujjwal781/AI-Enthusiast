...
class PrintOrders(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.tr_view.heading('tot_price', text="Total Price(INR)")
    ...
    def print_receipt(self):
        ...
        with open(r"C:\Users\omkar\Desktop\CSEProject\Components\order_template.html", 'r', encoding='utf-8') as html_doc:
